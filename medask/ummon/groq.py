...
class UmmonGroq(BaseUmmon):
    """
    Groq provider for fast inference on open-source models.
    
    Supports models like: llama-3.1-70b-versatile, llama-3.1-8b-instant, mixtral-8x7b-32768, etc.
    """
    
    def __init__(self, model: Optional[str] = None) -> None:
        self._model = model or "llama-3.1-70b-versatile"
